...
const long SettingsExternalFiles::ID_STATICLINE1 = wxNewId();
...
SettingsExternalFiles::SettingsExternalFiles(wxWindow* parent,wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name)
{
	...
	StaticText1 = new wxStaticText(this, wxID_ANY, _("as_csg - AngelCAD compiler"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	...
	BoxSizer2->Add(m_file_as_csg, 3, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer6->Add(m_text_outsub, 2, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer6->Add(m_nosubdir, 1, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer1->Add(BoxSizer6, 0, wxEXPAND, 5);
	BoxSizer3 = new wxBoxSizer(wxHORIZONTAL);
	StaticText2 = new wxStaticText(this, wxID_ANY, _("xcsg compiler"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	...
	BoxSizer3->Add(m_file_xcsg, 3, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer1->Add(BoxSizer3, 0, wxEXPAND, 5);
	BoxSizer7 = new wxBoxSizer(wxHORIZONTAL);
	StaticText6 = new wxStaticText(this, wxID_ANY, _("STL/AMF viewer"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	...
	BoxSizer7->Add(m_viewer_stl_amf, 3, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	...
	BoxSizer8->Add(m_viewer_dxf, 3, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer1->Add(BoxSizer8, 0, wxEXPAND, 5);
	...
	BoxSizer5->Add(m_file_openscad, 3, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	BoxSizer1->Add(BoxSizer5, 0, wxEXPAND, 5);
	StaticLine1 = new wxStaticLine(this, ID_STATICLINE1, wxDefaultPosition, wxSize(10,-1), wxLI_HORIZONTAL, _T("ID_STATICLINE1"));
	BoxSizer1->Add(StaticLine1, 0, wxALL|wxEXPAND, 5);
	BoxSizer4 = new wxBoxSizer(wxHORIZONTAL);
	StaticText3 = new wxStaticText(this, wxID_ANY, _("AngelCAD Online Help"), wxDefaultPosition, wxDefaultSize, 0, _T("wxID_ANY"));
	...
	BoxSizer4->Add(m_text_docurl, 3, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
